...
The RAC’s salary structure has been developed based on a detailed analysis of relevant labor markets (regional and national), general industry trends, and published salary data. The salary structure provides competitive salary grades and salary ranges that cover all positions. There are 14 salary grades, and each grade has a range of pay from minimum to maximum designed to keep RAC salaries competitive with similar jobs in relevant labor markets. The salary ranges will be reviewed every one to two years to ensure that they remain competitive, and they will be adjusted annually to keep consistent with the labor market. 

Minimum Range- The salary range that typically represents the range for newly hired, entry level, and recently promoted employees.  

Midpoint Range- The salary range that typically represents the competitive market value for the position and is usually the band for employees who are performing at expectation with more than 10 years of time in job.  
...
- Based on the information obtained, the President and Director of HR & Operations will conduct an analysis to examine the potential effect and cost implication of adopting the updated salary structure. 
...
- Following the President’s approval to create a new position, the supervisor and the program’s Director (if applicable) will draft a job description describing the duties to be assigned to the position. 
- A review of the duties and responsibilities of the position will be made by the President and the Director of HR & Operations. This review will include a comparison of job duties and responsibilities noted on the job description to those found in published salary surveys. 
...
- A review of a position's assignment is warranted when there has been a significant and permanent change in job duties. The employee’s supervisor is responsible for recognizing such changes. 
- Employees who believe their job is not properly assigned may make a request to their supervisor for a reassessment. Upon receiving such a request, the supervisor should conduct a thorough review and consult with the program’s Director. 
- If the supervisor concludes that a significant and permanent change in job duties has occurred, a request for a position reassignment should be made to the program’s Director who will then make a recommendation to the President. 
- An assessment of the duties and responsibilities of the position will be made by the President and the Director of HR & Operations against internal and external equity concerns, including relevant market data. 
- Following this evaluation, the President will determine if the position should remain as presently assigned or if a new assignment is appropriate. 
...
- At the time of promotion, a written request must be made by the employee’s supervisor, with specific details regarding increases in duties, responsibility, and authority. This request must be reviewed by the program’s Director and the Director of HR & Operations before the President can consider the request. 
...
- When changes occur to the salary structure and salary ranges are increased, there may be situations in which the salaries of employees fall below the minimum of their assigned range. 
- If it is found that an employee is below the minimum of that employee’s salary range, and the individual meets the required performance standards, action may be taken to provide the employee with a Bring to Minimum salary adjustment. 
...
- Requests for market adjustments may be made at any time during the year by the employee, employee’s supervisor, or the program’s Director. 
...
- Salary increase trends, as measured through third-party survey data. 
...
- If sufficient funds are available, the RAC will set aside a merit increase budget for the whole organization prior to the start of the fiscal year. 
- Merit increases will normally occur at the beginning of the fiscal year. 
...
- Recognition awards will normally occur at the beginning of the fiscal year. 
...
RAC full-time employees are scheduled to work seven (7) hours per day with a one-hour unpaid lunch break.  Part-time employees work a varied schedule depending on organizational needs.   Full-time employees work thirty-five (35) hours per week.  Part-time employees work less than thirty-five (35) hours per week.  Employees are expected to work their assigned schedule and are expected to maintain a consistent work schedule.   

### Overtime Pay 

The RAC overtime policy applies to all current non-exempt employees.  “Overtime” as defined by applicable law does not commence until employees work more than forty (40) hours in a workweek.  A standard workweek for full-time employees is defined as a thirty-five (35) hour workweek.  

All authorized work by non-exempt employees between thirty-five (35) and forty (40) hours in a workweek is compensated at the employee’s regular rate of pay.  All work by non-exempt employees in excess of forty (40) hours in a workweek is compensated at the rate of one and one-half times the employee’s regular rate of pay.  

It is the RAC’s policy that a supervisor’s authorization is required in advance of any time worked in excess of the standard thirty-five (35) hour workweek by any non-exempt employee. Non-exempt employees who anticipate the need to work additional hours must notify their supervisor and obtain approval in advance of working any hours that exceed the thirty-five (35) hour workweek.  Non-exempt employees who work more than a thirty-five (35) hour workweek without prior authorization may be subject to discipline, up to and including dismissal. 
...
Non-exempt employees should not work any hours beyond their regular schedule unless approved in advance by their supervisor. Employees are prohibited from performing any “off-the-clock” work. “Off-the-clock” work means work that may be performed, but not reported on an employee’s timecard.  Any employee who fails to report or inaccurately reports any hours worked will be subject to disciplinary action, up to and including termination. 
...
- Full day disciplinary suspensions for infractions of RAC’s written policies and procedures.  
...
Employees’ salaries  may also be reduced for certain types of deductions such as their portion of health, dental and life insurance premiums; state, federal or local taxes, social security, etc.  In any work week in which an employee performed any work, their salary will not be reduced for any of the following reasons: 

- Partial day absences for personal reasons, sickness or disability.  
- Absence on a day when the RAC decides  to close on a scheduled work day.  
